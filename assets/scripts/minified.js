...
function launchGallery() {
  ...
  document.querySelectorAll(".display-1:not(.is-unique), h2.text-uppercase:not(.is-unique)").forEach(function (e) {
    var t, n, i, o;n = (t = e).textContent.trim().split(" "), i = n[0], o = n.slice(1).join(" "), t.innerHTML = i + ' <span class="font-weight-normal">' + o + "</span>";
  });
}!function (e, t) {
  "use strict";
  ...
  var n = [],
    ...
    var t,
      ...
      if ((e.ownerDocument || e) !== f && h(e), t = t.replace(U, "='$1']"), n.matchesSelector && m && !T[t + " "] && (!v || !v.test(t)) && (!g || !g.test(t))) try {
      ...
      for (var t, n, o, r = e.length, s = i.relative[e[0].type], a = s || i.relative[" "], l = s ? 1 : 0, u = ye(function (e) {
        ...
        if (n = i.relative[e[l].type]) h = [ye(be(h), n)];else {
          if ((n = i.filter[e[l].type].apply(null, e[l].matches))[_]) {
            for (o = ++l; o < r && !i.relative[e[o].type]; o++) {}return we(l > 1 && be(h), l > 1 && ve(e.slice(0, l - 1).concat({ value: " " === e[l - 2].type ? "*" : "" })).replace(R, "$1"), n, l < o && Ee(e.slice(l, o)), o < r && Ee(e = e.slice(o)), o < r && ve(e));
          }h.push(n);
        }
      }return be(h);
  ...
  for (var e = "undefined" != typeof window && "undefined" != typeof document, t = ["Edge", "Trident", "Firefox"], n = 0, i = 0; i < t.length; i += 1) {
    ...
    }var i = n && n.nodeName;return i && "BODY" !== i && "HTML" !== i ? -1 !== ["TH", "TD", "TABLE"].indexOf(n.nodeName) && "static" === s(n, "position") ? h(n) : n : e ? e.ownerDocument.documentElement : document.documentElement;
  }function f(e) {
        ...
        z(n) && (o[t] += n * ("-" === e[i - 1] ? -1 : 1));
          ...
          if (j(e.instance.modifiers, "inner")) return e;if (e.flipped && e.placement === e.originalPlacement) return e;var n = D(e.instance.popper, e.instance.reference, t.padding, t.boundariesElement, e.positionFixed),
            ...
            if (i !== a || s.length === l + 1) return e;i = e.placement.split("-")[0], o = N(i);var c = e.offsets.popper,
                ...
                w = b || _;(h || v || w) && (e.flipped = !0, (h || v) && (i = s[l + 1]), w && (r = function (e) {
  ...
  function i(e, t) {
    ...
    function e(e) {
      ...
      var n = this;if (t(e).removeClass(p), t(e).hasClass(f)) {
    ...
    function e(e, t) {
      ...
      var i,
          ...
          h = Boolean(this._interval);if (e === O ? (i = R, o = W, r = P) : (i = z, o = B, r = j), u && t(u).hasClass(q)) this._isSliding = !1;else if (!this._triggerSlideEvent(u, r).isDefaultPrevented() && a && u) {
        this._isSliding = !0, h && this.pause(), this._setActiveIndicatorElement(u);var f = t.Event(M.SLID, { relatedTarget: u, direction: r, from: l, to: d });if (t(this._element).hasClass(F)) {
        ...
        } else t(a).removeClass(q), t(u).addClass(q), this._isSliding = !1, t(this._element).trigger(f);h && this.cycle();
      }
    }, e._jQueryInterface = function (n) {
      return this.each(function () {
    ...
    function e(e, t) {
      ...
      var e = t(this._element.parentNode),
          n = Se;return e.hasClass(fe) ? (n = Ce, t(this._menu).hasClass(ge) && (n = xe)) : e.hasClass(pe) ? n = De : e.hasClass(me) ? n = Ae : t(this._menu).hasClass(ge) && (n = Te), n;
    ...
    function e(e, t) {
      ...
      var e = this;if ("none" === t(this.element).css("display")) throw new Error("Please use show on visible elements");var i = t.Event(this.constructor.Event.SHOW);if (this.isWithContent() && this._isEnabled) {
        t(this.element).trigger(i);var o = c.findShadowRoot(this.element),
          ...
          var f = c.getTransitionDurationFromElement(this.tip);t(this.tip).one(c.TRANSITION_END, h).emulateTransitionEnd(f);
        } else h();
      }
    }, i.hide = function (e) {
      var n = this,
    ...
    return t.fn.tooltip = Xe, ft._jQueryInterface;
      ...
      vt = s({}, ft.Default, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' }),
      yt = s({}, ft.DefaultType, { content: "(string|element|function)" }),
      bt = "fade",
      _t = "show",
      wt = ".popover-header",
      Et = ".popover-body",
  ...
  }(ft);t.fn.popover = xt._jQueryInterface, t.fn.popover.Constructor = xt, t.fn.popover.noConflict = function () {
  ...
  }(), e.Util = c, e.Alert = m, e.Button = T, e.Carousel = K, e.Collapse = se, e.Dropdown = Ne, e.Modal = Be, e.Popover = xt, e.Scrollspy = jt, e.Tab = Xt, e.Toast = an, e.Tooltip = ft, Object.defineProperty(e, "__esModule", { value: !0 });
}), function (e) {
  "use strict";
  function t(t) {
  ...
  var ArrayProto = Array.prototype,
    ...
    var i = this,
      ...
      var t = I.length;if (k.performanceTrick && u && (clearTimeout(d), h || (u.addClass("scrollax-performance"), h = !0), d = setTimeout(function () {
        u.removeClass("scrollax-performance"), h = !1;
      }, 100)), t) {
        f = getOffset(e);for (var n = 0; n < t; n++) {
          v = I[n], (g = _position(v.element, e))[p ? "right" : "bottom"] < 0 || g[p ? "left" : "top"] > f[p ? "width" : "height"] || (y = v.options, m = y.offset || k.offset || 0, _ = g[p ? "right" : "bottom"], w = g[p ? "width" : "height"], (b = (w - _ + m) / w) < 0 && (_ = g[p ? "left" : "top"], w = f[p ? "width" : "height"], b = (w - _ + m) / w - 1), b > 1 || b < -1 || R(v, b));
        }B("scroll", f);
      }
    }function R(e, t) {
